...
Please use the following conventions. From here on \`good' and \`bad' are used to attribute things that would make the coding style match, or not match. It is more of a style and look call. Please try to follow these guidelines.
